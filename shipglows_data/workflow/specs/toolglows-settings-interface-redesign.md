...
next_step: "Collect operator-rendered light, dark and narrow proof in the loaded Chrome extension."
---
...
- Legacy PrimeVue variables resolve through ToolGlows semantic roles inside product dialogs.
...
- [x] Settings dialog legacy variables map to semantic ToolGlows roles in light and dark themes.
...
- Manual Chrome validation remains the explicit final owner when browser control cannot access the loaded unpacked extension.

## Execution Batches

### Batch 1 — Shared hierarchy

- Establish dialog-local semantic compatibility variables and clean field/section primitives.
...
- verification: partial — rendered Chrome proof remains operator-owned
